                  ...
                  Container(
                    ...
                    child: Stack(
                      children: [
                        ...
                        // SvgPicture.asset(title_green_curve,width: double.infinity,height: 100,fit:BoxFit.fill)

                        Image.asset(title_green_curve,width: double.infinity,fit:BoxFit.fill,)
                      ],
                    ),
                  ),
                  Stack(
                    children: [
                      Image.asset(img_title_box,fit: BoxFit.fill,),
                      Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
