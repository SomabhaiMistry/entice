...
class PlaywithFriendPlayer extends StatefulWidget {
  const PlaywithFriendPlayer({Key? key}) : super(key: key);

  @override
  State<PlaywithFriendPlayer> createState() => _PlaywithFriendPlayerState();
}

class _PlaywithFriendPlayerState extends State<PlaywithFriendPlayer> {
  @override
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Center(child: Image.asset(img_share,height: 45.h,width: 45.w,)),
                SizedBox(height: 30.h,),
                Center(
                  child: Stack(
                ...
                //     radius: 35.0,
                //     child: CircleAvatar(
                //       backgroundImage: AssetImage(icon_player2),
                //       radius: 33.0,
                //     ),
                //   ),
                // ),
